...
import iconoverlay from "../../../assets/images/icon_overlay.svg";

function HireHelp(props: any) {
    return (
        <> 
            <div className="row wrap benefit_row">
                {
                    props.help.map((data: any, key: number) => {
                        return (
                                ...
                                <div className="benefites_block">
                                    <div className="icon_box">
                                        ...
                                        <div className="icon_overlay">
                                            <ImageView src={iconoverlay} alt="startupIcon" />
                                        </div>
                                    </div>
                                    <h3>{data.title}</h3>
                                    <p>
