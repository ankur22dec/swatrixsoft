...
class GlobalDelivery extends React.Component {
  // componentWillMount() {
  // }
  componentDidMount() {
    ...
    return (
      <>
        <div>
                  ...
                  <div className="inner-left">
                    ...
                    >
                      ...
                      <h1>
                        Global
                        <br />
                        <span className="label-angular">Delivery</span>
                      </h1>
                    </div>
                  </div>
                </div>
          ...
          <div className="excellent-results mt-0 sr-from-bottom-1">
