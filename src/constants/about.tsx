export default {
    ...
    whatweDo: {
        title: "What We Do",
        descripion: "We pride ourselves for delivering world-class innovative digital solutions that bring a great impact. We have worked with top Fortune 500 companies, SMEs and Startups to bring worth through technology, strategies and creativity.",
        link:'our-services.html'
    },
    howWeDO: {
        title: "How We Do",
        description: "We take a time tested Why-What-How approach. Step 1 is to understand WHY something needs to be done. Step 2 is to discuss & define WHAT needs to be done and Step 3 is to execute it.",
        link:'solutions.html'
    },
    whyCmarix: {
        title: "Why CMARIX?",
        description: "We are focused to keep our processes lean, transparent and client-centric. We take great pride in our work quality and proactive communication with which we keep bringing tangible results for our customers. ",
    ...
    missionTwoTitle:"You Just Need A Mission-Driven Team To Deliver Mind-Boggling Results",
    friendsTitle:"Ready To Be <span>Friends?</span>",
    friendsDescription:"Are you excited to make most out of the technology and marketing opportunities? Are you fueled with changing needs and trends in the digital realm? Are you interested to work for Enterprise projects that bring challenges and get you on top?",
    funTitle:"The “Fun” At <span>CMARIX</span>",
    funDescription:"CMARIANS not only enjoy being active, smart, unstoppable developers and designers but they unite for fun-loving collaborative events.",
